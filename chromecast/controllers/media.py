...
class MediaStatus(object):
  ...
  def update(self, data):
    ...
    self.media_session_id = status_data.get('mediaSessionId',
    ...
    self.media_custom_data = media_data.get('customData',
                                            self.media_custom_data)
...
class MediaController(base.BaseController):
  ...
  def _send_command(self, command):
    ...
    if self.status is None or self.status.media_session_id is None:
      self.logger.warning("%s command requested but no session is active.",
  ...
  def play_media(self,
    ...
    def app_launched_callback():
      ...
      self._send_start_play_media(
          ...
          metadata, subtitles, subtitles_lang, subtitles_mime, subtitle_id)
  ...
  def _send_start_play_media(self,
                             url,
                             content_type,
                             title=None,
                             thumb=None,
